    ...
    : AudioProcessorEditor (&p), processorRef (p)
{
    ...
    bitDepthSlider = juce::Slider (juce::Slider::LinearHorizontal, juce::Slider::TextBoxRight);
    ...
    sampRateSlider = juce::Slider (juce::Slider::LinearHorizontal, juce::Slider::TextBoxRight);
    ...
    distDriveSlider = juce::Slider (juce::Slider::LinearHorizontal, juce::Slider::TextBoxRight);
    ...
    distThresholdSlider = juce::Slider (juce::Slider::LinearHorizontal, juce::Slider::TextBoxRight);
    ...
    distOversampleCombo = juce::ComboBox();
    ...
    noiseLevelSlider = juce::Slider (juce::Slider::LinearHorizontal, juce::Slider::TextBoxRight);
    ...
    popRateSlider = juce::Slider (juce::Slider::LinearHorizontal, juce::Slider::TextBoxRight);
    ...
    popIntensitySlider = juce::Slider (juce::Slider::LinearHorizontal, juce::Slider::TextBoxRight);
    ...
    filterFreqSlider = juce::Slider (juce::Slider::LinearHorizontal, juce::Slider::TextBoxRight);
    ...
    filterQSlider = juce::Slider (juce::Slider::LinearHorizontal, juce::Slider::TextBoxRight);
    ...
    mixSlider = juce::Slider (juce::Slider::LinearHorizontal, juce::Slider::TextBoxRight);
    ...
    outputGainSlider = juce::Slider (juce::Slider::LinearHorizontal, juce::Slider::TextBoxRight);
